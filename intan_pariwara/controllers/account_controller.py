...
from erpnext.controllers.accounts_controller import get_payment_terms, get_taxes_and_charges, force_item_fields
from intan_pariwara.stock.get_item_details import get_item_details
...
class AccountsController:
    ...
    def set_missing_item_details(self, for_validate=False):
        ...
        if hasattr(self, "items"):
            ...
            if self.doctype in ["Pre Order","Quotation", "Sales Order", "Delivery Note", "Sales Invoice"]:
