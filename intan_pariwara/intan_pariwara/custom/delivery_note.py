...
def detail_item_order(item, set_warehouse=None):
	ress = {}
	fields = ["price_list_rate", "rate", "discount_percentage", "rebate_rate", "custom_pre_order as against_pre_order", "custom_pre_order_item as pre_order_detail"]
